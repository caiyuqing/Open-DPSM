...
class interactive_plot:
    def plot(self):
        ...
        y_pred = self.modelResultDict[self.subject]["modelRegularization"][self.movieName]["pred"] 
        lumConv = self.modelResultDict[self.subject]["modelRegularization"][self.movieName]["lumConv"] 
        contrastConv = self.modelResultDict[self.subject]["modelRegularization"][self.movieName]["contrastConv"] 
