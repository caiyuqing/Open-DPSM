...
class pupil_prediction:
    ...
    def prepareRegionalWeightArr_pseudo(self):
        weightLeft_regions = np.array([0,1,2,3,8,9,10,11,16,17,18,19,24,25,26,27,32,33,34,35,40,41,42,43])
        weightRight_regions = np.array([4,5,6,7,12,13,14,15,20,21,22,23,28,29,30,31,36,37,38,39,44,45,46,47])
       
        weightRegionArr = np.empty(48)
        
        weightRegionArr[weightLeft_regions] = 1
        weightRegionArr[weightRight_regions] = 0
        self.weightRegionArr = weightRegionArr
