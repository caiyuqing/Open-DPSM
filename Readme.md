...
- [GUI](#gui): [main_app.py](main_app.py) (For those who don't use Python, a .exe form of the GUI can be found on https://osf.io/qvn64/. Download Open-DPSM.zip and unzip it. The GUI version of Open-DPSM can be start directly by running *Open-DPSM.exe*. Please note that the *App_fig* folder should at the same directory as the .exe)
